  ...
  ROOMS.street = {
    ...
    async enter(first) {
      if (!G.flags.introDone) {
        ...
        await E.sayRaw([
          { t: "PITTSBURGH. THE SOUTH SIDE. 10 PM. Meet Brendon Schenecker: 38, marketing genius (self-described), owner of one (1) white polyester leisure suit and a heart the size of his gold chain.", who: 'THE NARRATOR' },
